...
class GoogleDocsClient:
    ...
    def __init__(self, token_path: Optional[str] = None, creds_path: Optional[str] = None):
    ...
    def get_access_token(self) -> str:
        ...
        if not os.path.isfile(self.creds_path) or not os.path.isfile(self.token_path):
            raise RuntimeError(f"Google credentials not found at {self.creds_path} or {self.token_path}")
